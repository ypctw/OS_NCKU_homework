...
void Function1(void)
{
    //printf("[# INTO Function 1] thread %s\n",RUN_QUEUE->Thread->name);
    int i,j;
    while(1)
    {
...
void Function2(void)
{
    //printf("[# INTO Function 2] thread %s\n",RUN_QUEUE->Thread->name);
    int the_num;
    int min = 65400;
    int max = 65410;
    while(1)
...
void Function3(void)
{
    //printf("[# INTO Function 3] thread %s\n",RUN_QUEUE->Thread->name);
    while(1)
    {
        OS2021_ThreadWaitEvent(3);
...
void Function4(void)
{
    //printf("[# INTO Function 4] thread %s\n",RUN_QUEUE->Thread->name);
    while(1)
    {
...
void Function5(void)
{
    //printf("[# INTO Function 5] thread %s\n",RUN_QUEUE->Thread->name);
...
{
    printf("[# INTO ResourceReclaim] thread %s\n",RUN_QUEUE->Thread->name);
    while(1)
    {
